...
namespace Entidades
{
    public static class Datos
    {
        ...
        public static List<Empleado> CalcularEdadMayorA(int edad)
        {
            List<Empleado> listaAux = new List<Empleado>();
            if(listaEmpleados.Count != 0)
            {
                listaAux = listaEmpleados.FindAll((p) => p.Edad > edad);
            }
            else
            {
        ...
        /// <returns>List<Empleado> con todos los que cumplen la condicion</returns>
        public static List<Empleado> CalcularSexo(ESexo sexo)
        {
            List<Empleado> listaAux = new List<Empleado>();
            if(listaEmpleados.Count != 0)
            {
                listaAux = listaEmpleados.FindAll((p) => p.Sexo == sexo);
            }
            else
            {
        ...
        /// <returns>List<Empleado> con todos los que cumplen la condicion</returns>
        public static List<Empleado> CalcularNacionalidad(ENacionalidad nacionalidad)
        {
            List<Empleado> listaAux = new List<Empleado>();
            if(listaEmpleados.Count != 0)
            {
                listaAux = listaEmpleados.FindAll((p) => p.Nacionalidad == nacionalidad);
            }
            else
            {
                throw new ListVaciaException("Las listas no contienen datos");
        ...
        /// <returns>List<Empleado> con todos los que cumplen la condicion</returns>
        public static List<Empleado> CalcularEstadoCivil(EEstadoCivil estadoCivil)
        {
            List<Empleado> listaAux = new List<Empleado>();
            if(listaEmpleados.Count != 0)
            {
                listaAux = listaEmpleados.FindAll((p) => p.EstadoCivil == estadoCivil);
            }
            else
            {
                throw new ListVaciaException("Las listas no contienen datos");
        ...
        /// <returns>List<Empleado> con todos los que cumplen la condicion</returns>
        public static List<Empleado> CalcularPuesto(EPuesto puesto)
        {
            List<Empleado> listaAux = new List<Empleado>();
            if(listaEmpleados.Count != 0)
            {
            listaAux = listaEmpleados.FindAll((p) => p.Puesto == puesto);
            }
            else
            {
                throw new ListVaciaException("Las listas no contienen datos");
        ...
        /// <returns>List<Empleado> con todos los que cumplen la condicion</returns>
        public static List<Empleado> CalcularSueldoMayorA(double sueldo)
        {
            List<Empleado> listaAux = new List<Empleado>();
            if(listaEmpleados.Count != 0)
            { 
                listaAux = listaEmpleados.FindAll((p) => p.Sueldo > sueldo);
            }
            else
            {
                throw new ListVaciaException("Las listas no contienen datos");
        ...
        /// </summary>
        /// <returns>List<Empleado> con todos los que cumplen la condicion</returns>
        public static List<Empleado> CalcularPuestosActivos()
        {
            List<Empleado> listaAux = new List<Empleado>();
            if (listaEmpleados.Count != 0)
            {
                listaAux = listaEmpleados.FindAll((p) => p.Activo == true);
            }
            else
            {
